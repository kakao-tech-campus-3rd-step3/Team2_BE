...
class MemberRepositoryTest {
  ...
  void shouldSaveAndFindMemberByEmail() {
    // given
    Member frodo =
        TestMemberBuilder.aMember().withEmail("hyeonjun@example.com").withNickname("현준").build();
    Member sam =
        TestMemberBuilder.aMember().withEmail("flareseek@example.com").withNickname("지환").build();
