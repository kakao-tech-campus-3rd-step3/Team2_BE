...
public class SourceUploadRequest {
   ...
   * 업로드할 파일의 원본 이름
   *
   * <p>브라우저에서 file.name 속성을 통해 얻은 값입니다. 예: "PS-0-1. Orientation 및 코딩 테스트 준비하기.pdf"
   */
   ...
   * 파일의 MIME 타입
   *
   * <p>브라우저에서 file.type 속성을 통해 얻은 값입니다. 예: "application/pdf", "image/jpeg"
   */
   ...
   * 파일의 크기 (바이트 단위)
   *
   * <p>브라우저에서 file.size 속성을 통해 얻은 값입니다. S3 업로드 제한 검증에 사용됩니다.
   */
