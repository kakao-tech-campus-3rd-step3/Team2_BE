...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
    ...
    String targetUrl = UriComponentsBuilder.fromUriString(jwtProps.redirectUrl())
        .queryParam("accessToken", authTokens.accessToken()).build().toUriString();

    log.info("Set-Cookie headers before redirect: {}", response.getHeaders("Set-Cookie"));
