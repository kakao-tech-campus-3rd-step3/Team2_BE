...
VALUES (1, 123456789, 'test@example.com', '테스트유저', 'ACTIVE', NOW(), NOW()) ON DUPLICATE KEY
UPDATE kakao_id=
VALUES (kakao_id), email=
VALUES (email), name =
VALUES (name), status=
VALUES (status), updated_at=NOW();

INSERT INTO member (id, kakao_id, email, name, status, created_at, updated_at)
VALUES (2, 987654321, 'another@example.com', '어나더유저', 'ACTIVE', NOW(), NOW()) ON DUPLICATE KEY
UPDATE kakao_id=
VALUES (kakao_id), email=
VALUES (email), name =
VALUES (name), status=
